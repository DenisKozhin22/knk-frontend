...
import { useGetAllRequestsForAdmin } from '@/hooks'
...
import { AdminRequestsFilter } from './AdminRequestsFilter'
...
export function AdminRequestsList() {
	...
	const { data: requests, isLoading } = useGetAllRequestsForAdmin({
		limit,
		page,
		status,
		urgency
	...
	const onPageChange = (page: number) => {
		navigate({ to: '/requests', search: { page, limit, status, urgency } })
	}
